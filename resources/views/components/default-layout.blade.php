...
<body class="bg-zinc-100">
    <main>
        <header x-data="{ open: false }"
            ...
            <h1 class="text-lg sm:text-xl font-bold">Student Management</h1>
            ...
            <button x-on:click="open = !open"
                class="block sm:hidden bg-slate-50 border border-slate-300 p-2">
                <i class="ph ph-list block text-slate-800"></i>
            </button>
        ...
        <section class="px-3 sm:px-8 py-4 flex flex-col gap-4">
            <h2 class="text-2xl font-bold">{{ $section_title }}</h2>
            {{ $slot }}
        </section>
    </main>
</body>
